...
function MacroForge:CreateUI()
    ...
    local closeNew=CreateFrame("Button",nil,newPanel,"UIPanelCloseButton");closeNew:SetSize(28,28);closeNew:SetPoint("TOPRIGHT",-8,-8)
    closeNew:SetScript("OnClick",function() newPanel:Hide() end)
    ...
    local closeAdvanced=CreateFrame("Button",nil,self.advancedPanel,"UIPanelCloseButton");closeAdvanced:SetSize(28,28);closeAdvanced:SetPoint("TOPRIGHT",-8,-8)
    closeAdvanced:SetScript("OnClick",function() self.advancedPanel:Hide() end)
