...
local index={
    ...
    {"Where reminders show","reminder show in open world city cities inn dungeon raid pvp battleground arena condition","BuffReminder","buffs"},
    ...
    {"Dispel glow","dispel debuff cleanse purify decurse remove curse poison disease magic glow outline highlight","UnitColors","buffs"},
    ...
    {"Tooltip layout","tooltip layout order name race class level guild faction target line preview builder","Tooltip","tooltip"},
    {"Faction icon","faction icon horde alliance badge tooltip","Tooltip","tooltip"},
    ...
    {"Leveling stats","xp experience per hour time to level kills leveling rested background","Leveling","fps"},
    {"Faster looting","fast loot looting auto loot speed quick corpse","SystemGameplay","generic"},
    ...
    {"Quick keybind mode","kb /kb keybind keybinds bind hotkey hotkeys action bar keys quick","SystemGameplay","keybind"},
    {"Restore keybinds","keybind undo revert restore snapshot session history changes","SystemGameplay","reset"},
